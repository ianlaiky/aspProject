        ...
        <div class="card-content">
            <div class="input-group">
                ...
                <div class="form-group label-floating">
                    ...
                    <asp:CustomValidator ID="usernamex" runat="server" ErrorMessage="Only alphanumeric characters allowed" ControlToValidate="TextBox1" ForeColor="Red" OnServerValidate="usernameRe_OnServerValidate"></asp:CustomValidator>
